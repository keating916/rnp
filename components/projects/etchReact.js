        ...
        return(
            <main >
                ...
                <div id="etchContainer" style={divGrid(this.state.columns)}>
                    {this.state.array.map((i, index) => <div key={index} id={i} onTouchMove={e=> this.handleMouseOver(e)} onTouchStart = {e => this.handleMouseOver(e)} onMouseOver={e => this.handleMouseOver(e)} style={{backgroundColor: "white"}} ></div>)}</div>
            </main>
        )
    }
}